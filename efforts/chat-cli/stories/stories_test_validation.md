...
**Acceptance Criteria:**
- [ ] When I send a message and no effort is open, it is saved to the ambient raw log (`raw.jsonl`)
...
**Acceptance Criteria:**
- [ ] When I send a message while an effort is open, and the message contains at least one word from the open effort's name (case-insensitive, exact word match), it is saved to that effort's raw log (`efforts/X.jsonl`)
...
**Acceptance Criteria:**
- [ ] When I send a message while an effort is open, and the message contains NO words from the open effort's name (case-insensitive, exact word match), the message is routed to the ambient raw log
